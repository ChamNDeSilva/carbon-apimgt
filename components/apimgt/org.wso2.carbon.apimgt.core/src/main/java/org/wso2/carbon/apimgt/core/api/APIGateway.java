...
public interface APIGateway {
     ...
     * @throws GatewayException If there is a failure while adding CompositeAPI to gateway
     */
    void updateAPI(API api, boolean originalApiHadOwnGateway) throws GatewayException;
    ...
    /**
     * Startup a new Gateway in Container Management System (Kubernetes/Openshift)
     *
     *
     * @param id UUID of the API
     * @param label Auto-generated label of the API
     * @param apimConfigurations APIManager Configurations
     * @throws APIManagementException
     */
    void createContainerBasedGateway(String id, String label, APIMConfigurations apimConfigurations) throws
